return {
    Routes = {
        ["Easy.Win"] = {Route = "Easy", Variant = "Win"},
        ["Easy.Lose"] = {Route = "Easy", Variant = "Lose"},
        ["Molten"] = {Route = "Molten"},
        ["Hardcore"] = {Route = "Hardcore"},
        ["Fallen"] = {Route = "Fallen"},
        ["Frost"] = {Route = "Frost"}
    },
    ...
    Towers = {
        ...
        Info = {
            ...
            ["Soldier"] = {
                ...
                Price = 350,
                GrindRules = {
                    {MaxLevel = 49, Route = "Easy.Lose", FarmBehavior = "RestartUntilAffordable"}
                }
            },
